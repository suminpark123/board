        ...
        <el-col :span="20">
            <el-card>
                <div>
                    ...
                    <el-button @click="wrtieArticle" type="text" class="right-button">저장</el-button>
                </div>
                <br /><br />
...
export default{
    ...
    mounted() {
        if(this.$route.params.id){
            ...
            .then((response)=>{
            console.log('getArticle수정', response);
        ...
        wrtieArticle(){
            ...
            if(this.$route.params.id){
                apiBoard.patchArticle(this.$route.params.id,this.title,this.body)
                    .then((response)=>{
                        console.log(response,"수정patchArticle");
                        this.$route.push({path : `/board/detail/${this.$route.params.id}`});
                    })
                    .catch((e)=>{
                        console.log(e);
                    })
